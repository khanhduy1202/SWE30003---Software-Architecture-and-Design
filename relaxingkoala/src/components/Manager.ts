...
class Manager implements Staff {
	...
	addRecurringOrder(order: any): void {
		this.recurringOrderList.push(order);
	}

	hasPOSAccess(): boolean {
		return this.posSystemAccess;
	}
	...
	hasAdminSystemAccess(): boolean {
		return this.adminSystemAccess;
	}
}
